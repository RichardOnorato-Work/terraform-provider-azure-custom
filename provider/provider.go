...
import (
	...
	"os"
	"strings"
	"terraform-provider-azure-custom/clients"
	"terraform-provider-azure-custom/helpers"
	"terraform-provider-azure-custom/helpers/utils"
	"terraform-provider-azure-custom/resourceproviders"
	"terraform-provider-azure-custom/services/web"
...
func azureProvider(supportLegacyTestSuite bool) terraform.ResourceProvider {
	p := &schema.Provider{
		...
		ResourcesMap: map[string]*schema.Resource{
			"azure_custom_function_host_secret": web.ResourceFunctionAppHostSecret(),
		},
		DataSourcesMap: map[string]*schema.Resource{
			"azure_custom_function_host_secret": web.DataSourceFunctionHostKey(),
		},
	}
